...
public sealed partial class WorkflowBlockInput
{
    /// <summary>
    ...
    public List<WorkflowBlockFieldInput> InputFields { get; init; } = [];
    ...
    public List<WorkflowBlockCredentialFieldInput>? CredentialFields { get; init; }
